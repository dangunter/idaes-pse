...
from idaes.core.util.structfs.fsrunner import StructuredFlowsheet, Context
...
@flowsheet.substep("build", "add_props")
...
@flowsheet.substep("build", "add_units")
def add_units(m):
...
@flowsheet.substep("build", "create_arcs")
def connect_units(m):
...
@flowsheet.substep("build", "add_expressions")
def add_expr(m):
